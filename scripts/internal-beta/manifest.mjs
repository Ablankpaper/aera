...
export const INTERNAL_BETA_VERSION = "0.7.4-internal-beta.1";
...
function validateRuntimeLock(lock) {
  ...
  if (
    ...
    lock.release_tag !== "runtime-v0.18.2-agentera.1-rc.1"
  ) {
    throw new Error(
...
export function validateInternalBetaManifest(document) {
  ...
  if (
    ...
    document.runtimeSeed.releaseTag !== "runtime-v0.18.2-agentera.1-rc.1"
  ) {
