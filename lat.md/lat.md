...
- [[release-source-governance]] — the exact `Ablankpaper/aera` workflow, detached clean checkout, immutable SHA, and Git remote allowlist required before release operations.
