...
- Beta.33 Internal Beta Windows setup and portable artifacts require one Authenticode signer and trusted timestamps; their exact bytes, the x64 app ZIP, locked Runtime Seed, packaged startup proof, final native inventories, and signed update metadata are all bound to the canonical manifest.
