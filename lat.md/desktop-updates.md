...
- Beta.21 macOS evidence is hash-bound to the canonical manifest, rejects unsigned, ad-hoc, unnotarized, unstapled, or Gatekeeper-rejected bytes, and binds the accepted final DMG and ZIP submission IDs.
