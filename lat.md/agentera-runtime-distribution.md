...
Windows inventory hashing keeps the signed per-file checks while limiting I/O overhead: files up to 256 KiB use one bounded `readFile` operation and larger files use positional file-handle reads.
