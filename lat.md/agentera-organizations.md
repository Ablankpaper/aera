...
The multi-stage policy authoring renderer proof alone uses a bounded 20-second budget so slower hosted scheduling cannot truncate the assertion flow; every other case and the global timeout remain unchanged.
