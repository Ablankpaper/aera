...
Beta.33 keeps signed and notarized macOS packages while publishing Windows setup and portable bytes as explicitly unsigned controlled internal-Beta artifacts. Production candidates remain Authenticode fail-closed.
