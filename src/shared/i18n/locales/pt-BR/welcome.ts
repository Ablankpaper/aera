export default {
  title: "Bem-vindo ao AgentEra Studio",
  subtitle:
  ...
  dividerOr: "ou",
  connectRemote: "Conectar ao AgentEra Remoto",
  connectRemoteTitle: "Conectar ao AgentEra Remoto",
  connectRemoteSubtitle:
    "Insira a URL de um servidor da API do AgentEra em execução.",
