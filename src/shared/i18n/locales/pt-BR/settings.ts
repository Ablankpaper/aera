...
export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o Aera enviando dados de uso anônimos e agregados para o serviço de análise do projeto. Você pode desativar a qualquer momento.",
    disclosure: {
      ...
      endpoint:
        "Os dados são enviados para o serviço de análise do Aera. Gravações de sessão e captura automática de pageviews estão desativadas.",
      notCollected:
  ...
  updateSuccess: "Aera atualizado com sucesso.",
  ...
  poolHint:
    "Adicione várias chaves de API para o mesmo provedor para rotação automática e balanceamento de carga. O Aera alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe sua configuração do Aera, sessões, habilidades e memória.",
  ...
  migrationDesc:
    "Encontramos o OpenClaw em <code>{{path}}</code>. Você pode migrar sua configuração, chaves de API, sessões e habilidades para o Aera.",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o Aera instalado neste dispositivo",
  modeRemoteHint:
    "Conectar a um servidor da API do Aera na sua rede ou nuvem",
  remoteUrl: "URL Remota",
  remoteUrlHint:
    "A URL do servidor da API do Aera (deve expor /health e /v1/chat/completions)",
  ...
  serverConfigHint:
    "Você está conectado a um servidor remoto do Aera. A seleção de modelos, as chaves de API dos provedores e as credenciais são gerenciadas no host remoto em <code>~/.hermes/.env</code> e <code>config.yaml</code>. Edite-os lá e reinicie o servidor.",
  connectionMode: "Modo",
