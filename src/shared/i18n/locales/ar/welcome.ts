export default {
  ...
  dividerOr: "أو",
  connectRemote: "الاتصال بـ Aera عن بُعد",
  connectRemoteTitle: "الاتصال بـ Aera عن بُعد",
  connectRemoteSubtitle: "أدخل رابط خادم Aera API قيد التشغيل.",
