export default {
  title: "الذاكرة",
  subtitle: "ما يتذكره Aera عنك وعن بيئتك عبر الجلسات.",
  sessions: "الجلسات",
  messages: "الرسائل",
  memories: "الذكريات",
  ...
  noMemoriesYet:
    "لا توجد ذكريات بعد. سيحفظ Aera الحقائق المهمة أثناء المحادثة.",
  ...
  userProfileHint:
    "أخبر Aera عن نفسك — الاسم، الدور، التفضيلات، أسلوب التواصل.",
  providersHint:
    "مزوّدو الذاكرة القابلون للتوصيل يمنحون Aera ذاكرة طويلة المدى متقدمة. الذاكرة المدمجة (أعلاه) نشطة دائماً بجانب المزوّد المختار.",
