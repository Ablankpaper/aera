export default {
  title: "الذاكرة",
  subtitle: "ما يتذكره AgentEra عنك وعن بيئتك عبر الجلسات.",
  sessions: "الجلسات",
  messages: "الرسائل",
  memories: "الذكريات",
  ...
  noMemoriesYet:
    "لا توجد ذكريات بعد. سيحفظ AgentEra الحقائق المهمة أثناء المحادثة.",
  ...
  userProfileHint:
    "أخبر AgentEra عن نفسك — الاسم، الدور، التفضيلات، أسلوب التواصل.",
  providersHint:
    "مزوّدو الذاكرة القابلون للتوصيل يمنحون AgentEra ذاكرة طويلة المدى متقدمة. الذاكرة المدمجة (أعلاه) نشطة دائماً بجانب المزوّد المختار.",
