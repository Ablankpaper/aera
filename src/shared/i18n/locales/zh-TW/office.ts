export default {
  ...
  setupDesc1:
    "Claw3D 是你的 AgentEra Runtime 的 3D 視覺化環境。它讓你可以看到 Agent 在互動式辦公空間中工作。",
  setupDesc2:
  ...
  repStatusSignedOut: "請登入您的 AgentEra 帳戶以使用銀行。",
  ...
  repStatusForeign: "該智能體已關聯到另一個 AgentEra Studio 帳戶。",
} as const;
