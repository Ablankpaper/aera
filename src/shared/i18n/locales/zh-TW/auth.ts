const auth = {
  gate: {
    title: "登入 Aera",
    checking: "正在檢查 Aera 工作階段…",
    browserNote:
      "註冊、登入和找回密碼會在系統瀏覽器中安全完成。Aera 不會收集你的密碼或驗證碼。",
    ...
    retryFailed: "Aera 無法驗證目前工作階段，請重試。",
    cancelled: "已取消瀏覽器授權。",
    secureStorageTitle: "安全儲存空間無法使用",
    secureStorageDescription:
      "Aera 無法安全儲存此裝置工作階段。請啟用系統鑰匙圈或認證服務後重試，軟體絕不會改用明文儲存。",
    reasons: {
      sign_in_required: "使用 Aera 前，請先登入或建立帳戶。",
      offline_expired: "7 天離線使用期限已到，請連線並重新登入。",
      clock_rollback: "系統時間發生異常變更，請連線驗證此裝置。",
      device_revoked: "此裝置的授權已撤銷，請重新登入完成授權。",
      account_disabled: "此 Aera 帳戶目前已停用，請前往網頁帳戶中心處理。",
      account_pending_deletion: "此帳戶正等待刪除，無法授權 Aera。",
      secure_storage_unavailable: "Aera 工作階段必須使用系統安全儲存。",
    },
  },
  profile: {
    checkingTitle: "正在檢查本機資料存取權",
    checkingDescription:
      "Aera 只檢查歸屬中繼資料，不會開啟你的 Runtime 私密內容。",
    title: "選擇如何使用本機資料",
    existingDescription:
      "此裝置上偵測到既有 Aera Runtime 資料。你可以原地綁定，也可以建立獨立的全新空間。",
    noUpload:
    ...
    connectionBindingDescription:
      "正在把遠端或 SSH 連線綁定到目前 Aera 擁有者，產品 Token 不會傳送給 Runtime。",
    otherOwnerTitle: "此本機資料屬於另一個帳戶",
    otherOwnerDescription:
      "Aera 不會開啟或重新分配其他帳戶的本機智慧體資料。請建立獨立空白空間，或使用其擁有者帳戶登入。",
    remoteOtherOwnerTitle: "此 Runtime 連線屬於另一個帳戶",
    remoteOtherOwnerDescription:
      "Aera 不會繼承上一位擁有者的遠端或 SSH 連線內容。",
  ...
  offline: {
    title: "本機離線模式",
    description:
      "雲端帳戶功能已暫停；在簽章離線期限內，本機 Agent、模型 API 與 Aera Runtime 自我學習仍可正常使用。",
  },
  account: {
    settingsNav: "Aera 帳戶",
    title: "Aera 帳戶",
    openMenu: "開啟 Aera 帳戶選單",
    signIn: "登入",
    signingIn: "正在開啟瀏覽器…",
    ...
    rechargeSeparateAccount:
      "儲值會開啟獨立的模型 API 網站；該網站的帳戶、餘額、API Key、Cookie 與 Token 均不與 Aera 帳戶共用。",
