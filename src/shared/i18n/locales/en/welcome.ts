export default {
  title: "Welcome to AgentEra Studio",
  subtitle:
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote AgentEra",
  connectRemoteTitle: "Connect to Remote AgentEra",
  connectRemoteSubtitle: "Enter the URL of a running AgentEra API server.",
