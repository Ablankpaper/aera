export default {
  ...
  noMemoriesYet:
    "No memories yet. Aera will save important facts as you chat.",
  ...
  providersHint:
    "Pluggable memory providers give Aera advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
