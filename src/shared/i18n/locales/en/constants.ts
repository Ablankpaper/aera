export default {
  ...
  dashscopeDesc: "Qwen models via DashScope",
  dashscopeEndpoint: "DashScope Endpoint",
  dashscopeChinaEndpoint: "Mainland China",
  dashscopeIntlEndpoint: "International",
  ...
  auxiliaryProfileDescriber: "Agent describer",
  auxiliaryProfileDescriberHint: "automatic Agent descriptions",
