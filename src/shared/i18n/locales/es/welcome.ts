export default {
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a Aera remoto",
  connectRemoteTitle: "Conectarse a Aera remoto",
  connectRemoteSubtitle:
    "Introduce la URL de un servidor de API de Aera en ejecución.",
