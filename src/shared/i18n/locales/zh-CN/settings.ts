...
export default {
  ...
  updateOriginUnavailable: "当前应用未配置更新服务。",
  updateMetadataUnavailable: "无法获取更新信息。",
  updateMetadataInvalid: "更新信息无效。",
  updateDownloadFailed: "无法下载更新包。",
  updateSizeMismatch: "下载的更新包大小与预期不符。",
  updateHashMismatch: "下载的更新包未通过完整性校验。",
  updateSignatureInvalid: "无法验证更新签名。",
  updateRedirectRejected: "更新下载发生了不受信任的跳转，已拒绝。",
  updateExtractionFailed: "无法解压已验证的更新包。",
  updateStagingFailed: "待安装应用与预期更新不一致。",
  updateNativeStagingFailed: "待安装应用包含无效的原生组件。",
  updateSwapFailed: "Aera 无法切换到待安装版本。",
  updateLaunchFailed: "无法启动更新后的应用。",
  updateHealthFailed: "更新后的应用未通过启动健康检查。",
  updateRollbackFailed: "Aera 无法自动安全恢复之前的应用。",
  updateUnsupportedClient: "当前安装版本无法完成在线更新。",
  updateCancelled: "更新已取消。",
  updateUnknownFailure: "未能完成更新。",
  updateRolledBack: "更新未安装；已恢复之前的 Aera 应用。",
  updateRetry: "请重新尝试更新。",
  updateRestart: "请重启 Aera 后再尝试更新。",
  updateContactSupport: "请保留诊断 ID 并联系支持。",
  updateInstallManually: "请手动安装最新的已验证应用。",
  updateUseCurrentVersion: "请继续使用已恢复的版本。",
  updateTargetVersion: "目标版本：{{version}}",
  updateStage: {
    metadata: "阶段：获取更新信息",
    download: "阶段：下载",
    verify: "阶段：校验",
