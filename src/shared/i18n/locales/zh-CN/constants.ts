export default {
  ...
  petoiDesc: "兼容 OpenAI 接口的 Petoi 中转服务",
  petoiHint: "用于 https://api.petoi.cn/v1 的 API Key",
  aimlapiHint: "AIML API 的 API Key",
  hermesoneApiKey: "Hermes One API Key",
  hermesoneHint: "Hermes One 推理服务 — 快速、按额度计费的网关",
  ...
  nousHint: "Nous Portal API Key；如果已有 Nous 订阅，也可使用下方 OAuth 登录",
  ...
  atlascloudHint: "通过 AtlasCloud 使用 Claude、GPT 和开放模型",
  ...
  auxiliaryDescription:
    "辅助任务用于处理视觉、上下文压缩、网页提取等旁路工作。“自动”表示使用主模型；也可以按任务覆盖，以使用更便宜或更快的模型。",
  auxiliaryResetAll: "全部重置为自动",
  auxiliaryVision: "视觉",
  auxiliaryVisionHint: "图片和截图分析",
  ...
  auxiliarySkillsHubHint: "技能搜索和安装",
  auxiliaryApproval: "操作审批",
  auxiliaryApprovalHint: "智能命令审批",
  auxiliaryMcp: "MCP",
  auxiliaryMcpHint: "MCP 工具推理",
  auxiliaryTitleGeneration: "标题生成",
  auxiliaryTitleGenerationHint: "生成会话标题",
  auxiliaryTriageSpecifier: "分诊细化器",
  auxiliaryTriageSpecifierHint: "完善看板任务规格",
  auxiliaryKanbanDecomposer: "看板任务拆解器",
  auxiliaryKanbanDecomposerHint: "任务拆解",
  auxiliaryProfileDescriber: "智能体描述器",
  auxiliaryProfileDescriberHint: "自动生成智能体描述",
  auxiliaryCurator: "Curator",
  auxiliaryCuratorHint: "技能使用复盘",
  auxiliaryAuto: "自动",
