export default {
  ...
  setupDesc1:
    "Claw3D adalah lingkungan visualisasi 3D untuk agent Aera Anda. Ini memungkinkan Anda melihat agent bekerja di ruang office interaktif.",
  setupDesc2:
  ...
  repStatusSignedOut: "Masuk ke akun Aera Anda untuk menggunakan bank.",
  repStatusUnlinked:
  ...
  repStatusForeign: "Agen ini tertaut ke akun Aera yang berbeda.",
} as const;
