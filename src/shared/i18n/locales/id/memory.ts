export default {
  title: "Memori",
  subtitle:
    "Hal yang diingat Aera tentang Anda dan lingkungan Anda di berbagai sesi.",
  sessions: "Sesi",
  messages: "Pesan",
  memories: "Memori",
  ...
  noMemoriesYet:
    "Belum ada memori. Aera akan menyimpan fakta penting saat Anda chat.",
  ...
  userProfileHint:
    "Beri tahu Aera tentang diri Anda - nama, peran, preferensi, dan gaya komunikasi.",
  providersHint:
    "Provider memori pluggable memberi Aera memori jangka panjang yang lebih canggih. Memori bawaan (di atas) selalu aktif bersama provider yang dipilih.",
