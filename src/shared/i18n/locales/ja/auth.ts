const auth = {
  gate: {
    title: "Aera にサインイン",
    checking: "Aera セッションを確認しています…",
    browserNote:
      "登録、サインイン、パスワードの再設定はブラウザーで安全に行われます。Aera がパスワードや確認コードを収集することはありません。",
    ...
    retryFailed:
      "Aera はセッションを確認できませんでした。もう一度お試しください。",
    cancelled: "ブラウザー認証をキャンセルしました。",
    secureStorageTitle: "安全なストレージを利用できません",
    secureStorageDescription:
      "Aera はこのデバイスのセッションを安全に保存できません。システムのキーチェーンまたは資格情報サービスを有効にして再試行してください。平文保存には切り替わりません。",
    reasons: {
      sign_in_required:
        "Aera を使用する前に、サインインまたはアカウント登録を行ってください。",
      offline_expired:
      ...
      account_disabled:
        "この Aera アカウントは現在無効です。ブラウザーのアカウントページをご確認ください。",
      account_pending_deletion:
        "このアカウントは削除待ちのため Aera を認証できません。",
      secure_storage_unavailable:
        "Aera セッションにはシステムの安全なストレージが必要です。",
    },
  },
  profile: {
    checkingTitle: "ローカルデータへのアクセスを確認中",
    checkingDescription:
      "Aera は所有権メタデータだけを確認し、Runtime の非公開コンテンツは開きません。",
    title: "ローカルデータの使用方法を選択",
    existingDescription:
      "このデバイスに既存の Aera Runtime データがあります。そのまま関連付けるか、独立した空のスペースを作成してください。",
    noUpload:
    ...
    connectionBindingDescription:
      "リモートまたは SSH 接続を現在の Aera 所有者に関連付けています。製品 Token は Runtime に送信されません。",
    otherOwnerTitle: "このローカルデータは別のアカウントに属しています",
    otherOwnerDescription:
      "Aera は別のアカウントに属するローカルエージェントデータを開いたり再割り当てしたりしません。別の空スペースを作るか、所有者としてサインインしてください。",
    remoteOtherOwnerTitle: "この Runtime 接続は別のアカウントに属しています",
    remoteOtherOwnerDescription:
      "Aera は以前の所有者のリモートまたは SSH 接続情報を引き継ぎません。",
  ...
  offline: {
    title: "ローカルオフラインモード",
    description:
      "クラウドアカウント機能は一時停止します。署名済み期限まではローカル Agent、モデル API、Aera Runtime の学習を利用できます。",
  },
  account: {
    settingsNav: "Aera アカウント",
    title: "Aera アカウント",
    openMenu: "Aera アカウントメニューを開く",
    online: "オンライン・確認済み",
    ...
    unavailable: "Aera アカウント情報を利用できません。",
    userId: "アカウント ID",
    deviceId: "デバイス",
    ...
    rechargeSeparateAccount:
      "チャージは独立したモデル API サイトを開きます。そのアカウント、残高、API キー、Cookie、Token は Aera と共有されません。",
