...
describe("Aera control-plane schema", () => {
  it("creates the encrypted restore and conversation ownership boundaries in a fresh database", () => {
  ...
  it("adds conversation boundaries to an existing v7 database without migrating legacy sessions", () => {
