...
import { Check, FlaskConical, RefreshCw, Save, X } from "lucide-react";
import type {
  ...
  return (
    <section className="image-generation-config" aria-busy={busy === "load"}>
      <div className="image-generation-heading">
        <div>
          <h2>{t("tools.imageGeneration.title")}</h2>
          <p>{t("tools.imageGeneration.subtitle")}</p>
        </div>
        <label
        ...
        <>
            ...
            >
              ...
              <select
                ...
                onChange={(event) =>
                  update(
                    "quality",
                    event.target.value as ImageGenerationConfigDraft["quality"],
                  )
                }
              >
                <option value="low">
          ...
          {preview ? (
            <div className="image-generation-preview">
              <img src={preview} alt={t("tools.imageGeneration.previewAlt")} />
            </div>
          ) : null}
        </>
      )}
